...
void CUFRegisterAllocator() {
  allocatorRegistry.Register(kPinnedAllocatorPos, {&CUFAllocPinned, &CUFFreePinned});
  allocatorRegistry.Register(kDeviceAllocatorPos, {&CUFAllocDevice, &CUFFreeDevice});
  allocatorRegistry.Register(kManagedAllocatorPos, {&CUFAllocManaged, &CUFFreeManaged});
}

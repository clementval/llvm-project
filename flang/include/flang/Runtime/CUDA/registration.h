...
/// Load and registera module.
void RTDECL(CUFRegisterModule)(const char *name, void* data);

/// Unload and unregister a module.
void RTDECL(CUFUnregisterModule)(const char *name);

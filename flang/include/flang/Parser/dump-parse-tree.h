...
#define NODE(T1, T2) NODE_NAME(T1::T2, #T2)
  ...
  NODE_ENUM(parser::AccBlockDirective, Directive)
  NODE(parser, AccClause)
  NODE(parser::AccClause, Auto)
  NODE(parser::AccClause, Capture)
  NODE(parser::AccClause, Gang)
  NODE(parser::AccClause, Seq)
  NODE(parser::AccClause, Vector)
  NODE(parser::AccClause, Worker)
  NODE(parser::AccClause, Async)
  NODE(parser::AccClause, Attach)
  NODE(parser::AccClause, Bind)
  NODE(parser::AccClause, Collapse)
  NODE(parser::AccClause, Copy)
  NODE(parser::AccClause, Copyin)
  NODE(parser::AccClause, Copyout)
  NODE(parser::AccClause, Create)
  NODE(parser::AccClause, Default)
  NODE(parser::AccClause, DefaultAsync)
  NODE(parser, AccDefaultClause)
  NODE_ENUM(parser::AccDefaultClause, Arg)
  NODE(parser::AccClause, Delete)
  NODE(parser::AccClause, Detach)
  NODE(parser::AccClause, Device)
  NODE(parser::AccClause, DeviceNum)
  NODE(parser::AccClause, DevicePtr)
  NODE(parser::AccClause, DeviceResident)
  NODE(parser::AccClause, DeviceType)
  NODE(parser::AccClause, Finalize)
  NODE(parser::AccClause, FirstPrivate)
  NODE(parser::AccClause, Host)
  NODE(parser::AccClause, If)
  NODE(parser::AccClause, IfPresent)
  NODE(parser::AccClause, Independent)
  NODE(parser::AccClause, Link)
  NODE(parser::AccClause, NoCreate)
  NODE(parser::AccClause, NoHost)
  NODE(parser::AccClause, NumGangs)
  NODE(parser::AccClause, NumWorkers)
  NODE(parser::AccClause, Present)
  NODE(parser::AccClause, Private)
  NODE(parser::AccClause, Read)
  NODE(parser::AccClause, Reduction)
  NODE(parser::AccClause, Self)
  NODE(parser::AccClause, Tile)
  NODE(parser::AccClause, UseDevice)
  ...
  NODE_ENUM(parser::AccCombinedDirective, Directive)
  ...
  NODE_ENUM(parser::AccStandaloneDirective, Directive)
  NODE(parser, AccLoopDirective)
  NODE_ENUM(parser::AccLoopDirective, Directive)
